...
Axis_Marker_Data::Axis_Marker_Data(float axis_min, float axis_max)
{
    ...
    std::array<float, 9> possible_marker_steps = {multiple * 1,   multiple * 2,   multiple * 5,
                                                  multiple * 10,  multiple * 20,  multiple * 50,
                                                  multiple * 100, multiple * 200, multiple * 500};
 ...
 * Render w/ GL_LINES
 */
std::vector<float> Axis_Marker_Data::get_x_marker_points(float marker_top_y_coordinate,
                                                         float marker_bottom_y_coordinate) const
{
 ...
 * Render w/ GL_LINES
 */
std::vector<float> Axis_Marker_Data::get_y_marker_points(float marker_right_x_coordinate,
                                                         float marker_left_x_coordinate) const
{
