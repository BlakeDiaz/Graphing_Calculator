...
public:
    ...
    static std::string format_expression(std::unordered_map<char, UserFunction>& user_function_map, std::string expression); // Formattes expression for easier parsing
